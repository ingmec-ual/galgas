...
t1=cg(1)*1.0e-6*E;     % barra 4
t2=cg(2)*1.0e-6*E;     % barra 11
t3=cg(3)*1.0e-6*E;     % barra 12
t4=cg(4)*1.0e-6*E;     % barra 16
t5=cg(5)*1.0e-6*E;     % barra 17
t6=cg(6)*1.0e-6*E;     % barra 18
t7=cg(7)*1.0e-6*E;     % barra 19
