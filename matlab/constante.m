...
k2=[-1/2, 1/3, 2/3, sqrt(2)/6, -sqrt(2)/6, sqrt(2)/6, -sqrt(2)/6];
k3=[-1, 2/3, 4/3, -2*sqrt(2)/3, -sqrt(2)/3, sqrt(2)/3, -sqrt(2)/3];
k4=[-3/2, 1, 1, -sqrt(2)/2, sqrt(2)/2, sqrt(2)/2, -sqrt(2)/2];
k5=[-1, 4/3, 2/3, -sqrt(2)/3, sqrt(2)/3, -sqrt(2)/3, -2*sqrt(2)/3];
